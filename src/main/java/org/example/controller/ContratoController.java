...
public class ContratoController implements Serializable {
	...
	@Inject
	private ArrendatarioBusiness arrendatioBusiness;
	...
	public ArrendatarioBusiness getArrendatioBusiness() {
		return arrendatioBusiness;
	}

	public void setArrendatioBusiness(ArrendatarioBusiness arrendatioBusiness) {
		this.arrendatioBusiness = arrendatioBusiness;
	}
